...
var MetadataDecoder = artifacts.require('./encoder/MetadataDecoder.sol')
...
module.exports = async function (deployer, network, accounts) {
    ...
    await deployer.deploy(MetadataDecoder)
    MetadataDecoderInstance = await MetadataDecoder.deployed()
    await deployer.deploy(MurAllNFTL2, MetadataDecoderInstance.address, predicateProxyAddress, [
